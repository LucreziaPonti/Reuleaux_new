...
Go to add new display, add the display panel of your desired map (reachability) and set the topic to /reachability_map
...
rosrun map_generator load_reachability_map motorman_mh5_r0.08_rechability.h5 <ref_frame for the map>
